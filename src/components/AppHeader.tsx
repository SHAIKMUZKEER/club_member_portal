...
import { AwsLogo, ClubBadge } from "@/components/ClubBadge";
    ...
    <header className="sticky top-0 z-40 border-b border-white/70 bg-white/60 backdrop-blur-xl">
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-3 px-4">
        <div className="flex items-center gap-3">
          ...
          <ClubBadge className="hidden lg:inline-flex" />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="ml-1 hidden h-8 items-center border-l border-border/70 pl-3 sm:flex">
